# This file was extracted from https://github.com/scrapy/scrapy/blob/2.11.0/scrapy/utils/conf.py, renamed with the _untyped sufix and the types manually removed
