# This file was extracted from https://github.com/scrapy/scrapy/blob/2.11.0/scrapy/utils/iterators.py, renamed with the _untyped sufix and the types manually removed
...
@overload
def _body_or_str(obj):
    ...


@overload
def _body_or_str(obj, unicode):
    ...
